...
let nColorB = document.getElementById('color2');
let nColorC = document.getElementById('color3');
let nColorD = document.getElementById('color4');
let colorRgb = [];
...
function palletGenerator() {
  ...
  nColorB.style.backgroundColor = colorRgb[0]
  nColorC.style.backgroundColor = colorRgb[1]
  nColorD.style.backgroundColor = colorRgb[2]
}
